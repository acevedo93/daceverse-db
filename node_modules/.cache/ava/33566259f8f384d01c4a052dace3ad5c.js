...
test.beforeEach(async () => {
  ...
  AgentStub.update.withArgs(single, uuidArgs).returns(Promise.resolve(single)); // find all
...
test.serial('Agents#findConnected', async t => {
  ...
  t.true(AgentStub.findAll.called, 'findAll should be called once');
  t.deepEqual(agents, agentFixtures.connected, 'should be equal');
});
//# sourceMappingURL=/home/david/code/daceverse/daceverse-db/node_modules/.cache/ava/33566259f8f384d01c4a052dace3ad5c.js.map