...
test.beforeEach(async () => {
  ...
  MetricStub.create.withArgs(uuid, newMetric).returns(Promise.resolve(newMetric)); // agent stub
...
test.serial('Metric#create', async t => {
  ...
  t.true(AgentStub.findOne.calledWith(uuid), 'find One should be calle with uuid argument');
});
//# sourceMappingURL=/home/david/code/daceverse/daceverse-db/node_modules/.cache/ava/e321f271cf17df42d4f3496e10a0ab0f.js.map