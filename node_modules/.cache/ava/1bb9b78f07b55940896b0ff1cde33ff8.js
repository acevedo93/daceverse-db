...
test.beforeEach(async () => {
  ...
  MetricStub.create.withArgs(metricFixtures.newMetricMetric).returns(Promise.resolve({
    toJSON() {
      return metricFixtures.newMetricMetric;
    }
...
test.serial('Metric#create', async t => {
  ...
  t.true(MetricStub.create.calledWith(metricFixtures.newMetric), 'create should be called with specified newMetric Args'); // t.deepEqual(metric, newMetric, 'metric should be the same')
});
