...
test.beforeEach(async () => {
  ...
  MetricStub.create = sandbox.stub(); // MetricStub.create.withArgs(metricFixtures.newMetric).returns(Promise.resolve({
  //   toJSON () {
...
test.serial('Metric#create', async t => {
  ...
  t.true(MetricStub.create.calledOnce, 'create should be called once'); // t.true(MetricStub.create.calledWith(metricFixtures.newMetric), 'create should be called with specified newMetric Args')
