...
test.beforeEach(async () => {
  ...
  AgentStub.update.withArgs(single, uuidArgs).returns(Promise.resolve(single)); // AgentStub.create = sandbox.stub();
...
test.serial('Agent#create when agent dont exists', async t => {
  const agent = await db.Agent.createOrUpdate(newAgent);
  t.true(AgentStub.findOne.called, 'should be called');
});
//# sourceMappingURL=/home/david/code/daceverse/daceverse-db/node_modules/.cache/ava/34af50248aaf832ea6570228b1f597e8.js.map