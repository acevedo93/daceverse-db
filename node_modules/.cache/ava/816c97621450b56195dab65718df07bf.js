...
test.serial('Metric#findByTypeAgentUuid', async t => {
  const metric = await db.metricfind.ByTypeAgentUuid(type, uuid);
  t.true(MetricStub.findAll.called, 'find all should be called');
  t.true(MetricStub.findAll.calledOnce, 'findAll should be called once');
  t.true(MetricStub.findAll.calledWith(findAllArgs), 'findAll should be called without args');
});
//# sourceMappingURL=/home/david/code/daceverse/daceverse-db/node_modules/.cache/ava/816c97621450b56195dab65718df07bf.js.map