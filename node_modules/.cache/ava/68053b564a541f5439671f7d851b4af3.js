...
test.beforeEach(async () => {
  ...
  MetricStub.create.withArgs(newMetric).returns(Promise.resolve(newMetric)); // agent stub
...
test.serial('Metric#create', async t => {
  ...
  t.true(MetricStub.create.calledWith(uuid, newMetric), 'create should be called with specified newMetric Args');
});
//# sourceMappingURL=/home/david/code/daceverse/daceverse-db/node_modules/.cache/ava/68053b564a541f5439671f7d851b4af3.js.map