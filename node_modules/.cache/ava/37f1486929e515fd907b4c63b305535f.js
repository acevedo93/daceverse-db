...
test.beforeEach(async () => {
  ...
  MetricStub.findAll.withArgs(findByTypeUuidArgs).returns(Promise.resolve(metricFixtures.findByTypeAgentUuid(type, uuid))); // find by agent uuid

  MetricStub.findAll.withArgs(findAllArgs).returns(Promise.resolve(metricFixtures.findByAgentuuid(uuid))); // agent stub
...
//# sourceMappingURL=/home/david/code/daceverse/daceverse-db/node_modules/.cache/ava/37f1486929e515fd907b4c63b305535f.js.map